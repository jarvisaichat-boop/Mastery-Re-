...
function loadHabitsFromStorage(): Habit[] {
  ...
  // Return initial test data if nothing is stored
  return [
    { 
      id: 1, 
      ...
      repeatDays: 1,
      order: 0,
      completed: { "2025-01-25": true, "2025-01-26": true, "2025-01-27": true, "2025-01-28": true } 
    },
    { 
      id: 2, 
      ...
      repeatDays: 1,
      order: 1,
      completed: { "2025-01-25": true, "2025-01-26": false } 
    },
    { 
      id: 3, 
        ...
        <div>
            ...
            <div className="grid grid-cols-7 gap-1">
                {monthDays.map((date, index) => {
                    ...
                    const scheduledHabits = habits.filter(habit => isHabitScheduledOnDay(habit, date));
...
const HabitRow: React.FC<{
    ...
    const getHabitBackgroundColor = (habitType: string): string => {
        switch (habitType) {
            case 'Anchor Habit':
                return 'bg-blue-500/10 rounded-lg';
            case 'Life Goal Habit':
                return 'bg-red-500/10 rounded-lg';
            default:
                return '';
        }
    };
        ...
        >
            {showCircles ? (
                <div className="flex justify-between items-center mb-4">
                    ...
                    >
                        <span className={`${getHabitBackgroundColor(habit.type)} px-2 py-1 rounded-lg`}>
                            {habit.name}
                        </span>
                    </button>
                    {currentStreak > 0 && (
...
function App() {
    ...
    // Add useEffect hook to save data
    useEffect(() => {
        try {
