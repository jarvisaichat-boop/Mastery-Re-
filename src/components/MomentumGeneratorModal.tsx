        ...
        <div className="w-full h-full flex flex-col p-4 sm:p-6 pb-24">
          <div className="flex-1 flex flex-col items-center justify-start pt-8">
            ...
            <div className="flex justify-center w-full">
              <button
                ...
                className={`relative text-left p-5 sm:p-6 rounded-2xl border-2 transition-all duration-300 w-full max-w-[280px] ${goalSelected
              ...
              >
                <div className={`absolute top-4 right-4 w-7 h-7 sm:w-8 sm:h-8 rounded-full border-2 flex items-center justify-center transition-all ${goalSelected
          ...
          <div className="fixed bottom-8 left-0 right-0 flex justify-center z-50" style={{ paddingBottom: 'env(safe-area-inset-bottom, 0px)' }}>
            <button
              ...
              className={`w-14 h-14 rounded-full transition-transform ${goalSelected
    ...
    if (currentStep === 'habits') {
          ...
          <div className="flex-1 flex flex-col items-center justify-start pt-8">
            ...
            <div className={`flex flex-wrap justify-center gap-4 sm:gap-6 mb-8 sm:mb-10 ${lifeGoals.length === 1 ? 'items-center min-h-[200px]' : ''}`}>
              {lifeGoals.map(habit => {
                ...
                className={`group relative text-left p-5 sm:p-6 rounded-2xl border-2 transition-all duration-300 w-full max-w-[280px] ${isSelected
              ...
              >
                ...
                <div className={`absolute top-4 right-4 w-7 h-7 sm:w-8 sm:h-8 rounded-full border-2 flex items-center justify-center transition-all ${isSelected
                      ? 'bg-yellow-500 border-yellow-500 scale-125'
                      : 'border-gray-600'
                  }`}>
                  {isSelected && (
      ...
      <div className="fixed bottom-8 left-0 right-0 flex justify-center z-50" style={{ paddingBottom: 'env(safe-area-inset-bottom, 0px)' }}>
        <button
          ...
          className={`w-14 h-14 rounded-full transition-transform ${selectedHabits.size > 0
                ? 'bg-gradient-to-br from-yellow-400 to-orange-500 cursor-pointer hover:scale-110 animate-pulse'
                : 'bg-gray-700 cursor-not-allowed'
            }`}
        ...
        <div className="w-full h-full overflow-y-auto p-4 sm:p-6 pb-32">
          ...
          <div className="fixed bottom-8 left-0 right-0 flex justify-center z-50" style={{ paddingBottom: 'env(safe-area-inset-bottom, 0px)' }}>
            <button
              ...
              className={`w-14 h-14 rounded-full transition-transform ${selectedStarterAction
                  ? 'bg-gradient-to-br from-yellow-400 to-orange-500 cursor-pointer hover:scale-110 animate-pulse'
                  : 'bg-gray-700 cursor-not-allowed'
                }`}
          ...
          onClick={() => {
            if (!pledgeCardFlipped && commitmentReady) {
              if (isFirstActivationToday) {
                ...
                // Subsequent activations: skip flip AND Start Countdown screen, show 3-2-1 pre-countdown
                setLaunchCountdown(60);
        ...
        >
          ...
          >
                ...
                <div className="flex justify-center mt-4 sm:mt-6 md:mt-8">
                  <div
                    className={`w-10 h-10 sm:w-12 sm:h-12 md:w-14 md:h-14 rounded-full transition-all duration-500 ${commitmentReady
                      ? 'bg-gradient-to-br from-yellow-400 to-orange-500 cursor-pointer hover:scale-110 animate-pulse'
                    ...
                    onClick={(e) => {
                      ...
                      if (commitmentReady) {
                        if (isFirstActivationToday) {
                          ...
                          // Skip to launch, show 3-2-1 pre-countdown first (skip Start Countdown screen)
                          setLaunchCountdown(60);
                          setLaunchActive(true);
                          setPreCountdown(3);
                          setCurrentStep('launch');
          ...
          <div className="relative w-full h-full flex flex-col items-center justify-center">
            ...
            <div className="relative z-10 text-center">
              <div className="animate-pulse">
                  <div className={`text-[12rem] font-black font-mono mb-8 transition-all duration-300 ${launchCountdown <= 10 ? 'text-yellow-400' : 'text-yellow-500'
                    }`} style={{ textShadow: `0 0 ${launchCountdown <= 10 ? '100px' : '60px'} rgba(251, 191, 36, 0.8)` }}>
                    {launchCountdown}
                  </div>
              <p className={`text-5xl font-black transition-all mb-4 ${launchCountdown <= 10 ? 'text-white animate-bounce' : 'text-yellow-400'
