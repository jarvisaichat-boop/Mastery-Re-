...
export default function MicroWinProtocol({ habit, aiPersona, onComplete }: MicroWinProtocolProps) {
  ...
  const renderStep = () => {
    switch (step) {
      ...
      case 6:
        ...
        return (
          <div className="min-h-screen bg-gradient-to-br from-green-950 via-emerald-900 to-green-950 flex items-center justify-center p-6">
            <div className="max-w-2xl w-full space-y-8 animate-fadeIn">
              <div className="text-center space-y-6">
      ...
      case 7:
        // Momentum Push
        return (
          <div className="min-h-screen bg-gradient-to-br from-gray-950 via-purple-900 to-gray-950 flex items-center justify-center p-6">
            <div className="max-w-2xl w-full space-y-8 animate-fadeIn">
              <div className="text-center space-y-6">
