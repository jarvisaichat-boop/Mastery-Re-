export function StreakBoardBase() {
  const streakCount = 7;
  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        Variation B — Streak Board Base
      </div>

      {/* ══════════════════════════════════════
          STREAK BOARD HEADER — original orange tone (unchanged)
          ══════════════════════════════════════ */}
      <div style={{ position: 'relative', paddingTop: 36 }}>
        ...
        <div style={{ position: 'relative', padding: '42px 24px 0' }}>
          ...
          <div style={{
            ...
            <div>
              <div style={{ fontSize: 11, fontWeight: 600, color: 'rgba(255,248,240,0.5)', letterSpacing: 1, textTransform: 'uppercase', marginBottom: 2 }}>Sessions Done</div>
              <div style={{ fontSize: 28, fontWeight: 800, color: '#fff8f0', lineHeight: 1 }}>3</div>
            </div>
            <div style={{ marginLeft: 'auto', textAlign: 'right' }}>
              <div style={{ fontSize: 11, fontWeight: 600, color: 'rgba(255,248,240,0.5)', letterSpacing: 1, textTransform: 'uppercase', marginBottom: 2 }}>Best Streak</div>
              <div style={{ fontSize: 28, fontWeight: 800, color: '#fff8f0', lineHeight: 1 }}>12</div>
            </div>
          </div>
        </div>
      ...
      <div style={{ flex: 1, padding: '24px 20px 0', display: 'flex', flexDirection: 'column', gap: 10 }}>
        {['Morning Workout', 'Read 20 minutes', 'Cold shower'].map((name, i) => (
          <div key={i} style={{
            ...
            <div style={{ fontSize: 14, fontWeight: 500, color: i === 0 ? 'rgba(255,248,240,0.9)' : 'rgba(255,255,255,0.55)' }}>{name}</div>
          </div>
        ))}
      </div>

      {/* ══════════════════════════════════════
          MG BUTTON — NOW uses streak board's orange-amber base
          instead of the usual yellow-gold gradient
          ══════════════════════════════════════ */}
      <div style={{
        ...
        {/* Floor glow — matches streak board orange */}
        <div style={{
        ...
        {/* Semicircle button — now uses streak board's #fb923c base */}
        <div style={{
          width: 160, height: 80,
